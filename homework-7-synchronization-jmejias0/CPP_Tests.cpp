...
const size_t G_LINE_COUNT_PER_TYPE_MINIMUM	= 250000;
...
{
	//
	auto t = tests.createTest("Generate Files");
...
{
	//
	auto t = tests.createTest("Characters");
...
{
	//
	auto t = tests.createTest("Race condition");
...
{
	//
	auto t = tests.createTest("Critical section");
